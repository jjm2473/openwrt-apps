...
local type0_path = "/sys/devices/virtual/thermal/thermal_zone0/trip_point_0_type"
...
if fs.access(type0_path) and "active" == luci.util.trim(fs.readfile(type0_path)) then
